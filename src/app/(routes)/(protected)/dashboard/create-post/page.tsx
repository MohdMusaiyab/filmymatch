...
const CreatePostPage = () => {
  ...
  const categoryOptions = CategoryEnum.options.map((opt) => ({
    value: opt,
    label: opt,
  }));
          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                placeholder="What's your snippet about?"
              />
            </div>
            {errors.title && (
          ...
          <div>
            ...
            <div className="relative">
              <textarea
                ...
                placeholder="Describe your code snippet, what it does, and any important notes..."
              />
            </div>
            {errors.description && (
              <div className="mt-2 flex items-center text-red-600 text-sm">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
              <div>
                <p className="text-sm text-gray-600">
                  <span className="font-medium">Note:</span> Your snippet will
                  be saved as a draft. You&apos;ll add images and publish in the
                  next step.
                </p>
              </div>
              <Button
